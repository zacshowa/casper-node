...
pub(crate) enum Event {
    ...
    #[from]
    StateStoreRequest(Box<StateStoreRequest>),
...
impl From<NetRequestIncoming> for Event {
    #[inline]
    fn from(request: NetRequestIncoming) -> Self {
        Event::NetRequestIncoming(Box::new(request))
    }
}
...
impl From<StateStoreRequest> for Event {
    #[inline]
    fn from(request: StateStoreRequest) -> Self {
